...
public class NumberFieldDataListFilterType extends DataListFilterTypeDefault {

    public String getName() {
        return "Number Field Data List Filter Type";
    }
    ...
    public String getDescription() {
        return "Data List Filter Type - Number Field";
    }
    ...
    public String getTemplate(DataList datalist, String name, String label) {
        ...
        return pluginManager.getPluginFreeMarkerTemplate(dataModel, getClassName(), "/templates/numberFieldDataListFilterType.ftl", null);
    }
    ...
    public DataListFilterQueryObject getQueryObject(DataList datalist, String name) {
        ...
        if (datalist != null && datalist.getBinder() != null && getValue(datalist, name) != null && !getValue(datalist, name).isEmpty()) {
            String number_from=getValue(datalist,name);
            String [] str_number=number_from.split(";");
            queryObject=getQuery(datalist.getBinder().getColumnName(name),str_number);
            return queryObject;
        }
        return null;
    }
